        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PendingApprovalDays = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeesLeaveTypes", x => new { x.EmployeeId, x.LeaveTypeId });
                    table.ForeignKey(
                        name: "FK_EmployeesLeaveTypes_AspNetUsers_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaveTypeId = table.Column<int>(type: "int", nullable: false),
                    RequestEmployeeId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SubstituteEmployeeId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ApprovedBySubstitute = table.Column<bool>(type: "bit", nullable: false),
                    ApproveEmployeeId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Leaves_AspNetUsers_ApproveEmployeeId",
                        column: x => x.ApproveEmployeeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Leaves_AspNetUsers_RequestEmployeeId",
                        column: x => x.RequestEmployeeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Leaves_AspNetUsers_SubstituteEmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Leaves_ApproveEmployeeId",
                table: "Leaves",
